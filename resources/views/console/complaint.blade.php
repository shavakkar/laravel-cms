        ...
        <div class="col-span-12 lg:col-span-3">
            <div class="col-span-12 xxl:col-span-6" id="addService">
                <div class="box">
                    <div class="box-header">
                        <h5 class="box-title">Add Complaints</h5>
                    </div>
                    <div class="box-body">
                        <form class="space-y-3" id="disposalForm" name="disposalForm" method="post"
                            ...
                            <div>
                                <div>
                                    <h5 class="box-title">Received From</h5>
                                </div>
                                <div class="mt-3">
                                    <div class="rounded-sm">
                                        <input type="text" id="from" name="from" placeholder="Enter Complaints"
                            ...
                            <div>
                                <div>
                                    <h5 class="box-title">Month End Pending</h5>
                                </div>
                                <div class="mt-3">
                                    <div class="rounded-sm">
                                        <input type="text" id="monthpending" name="monthpending"
                                            placeholder="Enter Month End Pending"
                                            class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div>
                                    <h5 class="box-title">Total Pending</h5>
                                </div>
                                <div class="mt-3">
                                    <div class="rounded-sm">
                                        <input type="text" id="pending" name="pending"
                            ...
                            <div>
                                <div>
                                    <h5 class="box-title">Pending Complaints > 3 Months</h5>
                                </div>
                                <div class="mt-3">
                                    <div class="rounded-sm">
                                        <input type="text" id="pending3" name="pending3"
                                            placeholder="Enter Pending Complaints"
                                            class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div>
                                    <h5 class="box-title">Average Resolution Time</h5>
                                </div>
                                <div class="mt-3">
                                    <div class="rounded-sm">
                                        <input type="text" id="avg" name="avg"
                                            placeholder="Enter Average Resolution Time"
                                            class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="hide" id="editService">
                <div class="col-span-12 lg:col-span-5">
                    <div class="box">
                        <div class="box-header">
                            <h5 class="box-title">Edit Complaints</h5>
                        </div>
                        <div class="box-body">
                            <form name="formService" id="formService" class="space-y-3" method="POST"
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            ...
                                            <input type="text" id="complaintFrom" name="from"
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            <input type="text" id="complaintMonthpending" name="monthpending"
                                                placeholder="Enter Month End Pending"
                                                class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            <input type="text" id="complaintReceived" name="received"
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            <input type="text" id="complaintResolved" name="resolved"
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            <input type="text" id="complaintPending" name="pending"
                                                placeholder="Enter Total Pending"
                                                class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            <input type="text" id="complaintPending3" name="pending3"
                                                placeholder="Enter Pending Complaints"
                                                class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            <input type="text" id="complaintAvg" name="avg"
                                                placeholder="Enter Average Resolution Time"
                                                class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                        </div>
                                    </div>
...
@section('scripts')
    <script src="{{ asset('') }}console/assets/js/datatableSRComplaints.js"></script>
    <script src="{{ asset('') }}console/assets/projects/complaints/index.js"></script>
@endsection
