...
@section('content')
    ...
    <div class="block justify-between page-header md:flex">
        <div>
            <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium">Yearly
                Disposal
            </h3>
        </div>
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 lg:col-span-3">
            ...
            <div class="col-span-12 xxl:col-span-6" id="addService">
                <div class="box">
                    <div class="box-header">
                        <h5 class="box-title">Add Yearly Disposal</h5>
                    </div>
                    <div class="box-body">
                        <form class="space-y-3" id="disposalForm" name="disposalForm" method="post"
                            ...
                            <div>
                                ...
                                <div class="mt-3">
                                    <div class="rounded-sm">
                                        <input type="text" id="forward" name="forward" placeholder="Enter complaints"
                                            class="py-2 mb-1 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="hide" id="editService">
                <div class="col-span-12 lg:col-span-5">
                    <div class="box">
                        <div class="box-header">
                            <h5 class="box-title">Edit Yearly Disposal</h5>
                        </div>
                        <div class="box-body">
                            <form name="formService" id="formService" class="space-y-3" method="POST"
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            ...
                                            <input type="text" id="disposalYear" name="year" placeholder="Enter year"
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="rounded-sm">
                                            <input type="text" id="disposalForward" name="forward"
        ...
        <div class="col-span-12 lg:col-span-9">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">Yearly Disposal</h5>
                </div>
                <div class="box-body">
...
@section('scripts')
    <script src="{{ asset('') }}console/assets/projects/disposalYear/index.js"></script>
    <script src="{{ asset('') }}console/assets/js/datatableSRYearlyDisposal.js"></script>
@endsection
