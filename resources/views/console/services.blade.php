...
@section('content')
    ...
    <div class="block justify-between page-header md:flex">
        <div>
            <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium">Services
            </h3>
        </div>
    </div>
    <!-- Page Header Close -->
            ...
            <div class="col-span-12 xxl:col-span-6" id="addService">
                <div class="box">
                    <div class="box-header">
                        <h5 class="box-title">Add Service</h5>
                    </div>
                    <div class="box-body">
                        <form class="space-y-3" id="serviceForm" name="serviceForm" enctype="multipart/form-data">
                            @csrf
                            <div>
                                <div>
                                    <h5 class="box-title">Name Field</h5>
                                </div>
                                <div class="mt-3">
                                    <div class="rounded-sm">
                                        <input type="text" id="name" name="name" placeholder="Enter a Name"
                                            class="py-2 mb-3 px-3 rtl:pl-11 ti-form-input rounded-none ltr:rounded-r-sm rtl:rounded-l-sm focus:z-10">
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div>
                                    ...
                                    <p class="text-green-600 text-[10px]">Description should be &lt; 300 characters</p>
                                </div>
                                <div class="mt-3">
                                    <div>
                                        <textarea class="ti-form-input mb-3" id="description" name="description" rows="3"
                                            placeholder="Give some thoughts here..."></textarea>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-5">
                                    <input type="file" name="image" id="image"
                                        class="filepond basic-filepond w-64 mb-3" onchange="previewFile(this);"
                            ...
                            <form name="formService" id="formService" class="space-y-3" method="POST"
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div>
                                            <h5 class="box-title">Description</h5>
                                            <p class="text-green-600 text-[10px]">Description should be &lt; 300 characters
                                            </p>
                                        </div>
                                        <div class="mt-3">
                                            <div>
                                                <div class="space-y-2">
                                                    <textarea class="mb-3 ti-form-input" id="serviceDescription" name="description" rows="3"
                                                        placeholder="Give some thoughts here..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <p class="text-green-600 text-[10px]">Both Images must be jpg, jpeg, png!</p>
                                        <p class="text-green-600 text-[10px] -mt-2">and Both Images size should be &lt; 1 Mb
                                        </p>
                                    </div>
                                    <div class="mt-5">
                ...
                <div
                    ...
                    <div class="ti-modal-content">
                        ...
                        <div class="ti-modal-footer">
                            ...
                            <a class="ti-btn cursor-pointer" id="delBtn1" style="background-color: red; color: white;">
                                Delete
                            </a>
                        </div>
                    </div>
...
@section('scripts')
    <script src="{{ asset('') }}console/assets/js/datatableSRService.js"></script>
    <script src="{{ asset('') }}console/assets/projects/services/index.js"></script>
@endsection
