...
@section('content')
    <div class="search-input-area mt--30">
        ...
        <div class="container" style="height: 100%">
            ...
            <ul class="pl-0 list-none">
                <li>
                    <span>
                        <i class="me-3 text-danger uil uil-check"></i>
                    </span>
                    <span>SEBI
                        Registration Number: INH200000000.</span>
                </li>
                <li><span><i class="me-3 text-danger uil uil-check"></i></span><span>Our
                        Official website is www.Testseva.com, <br> E-Mail Id:
                        <b>{{ $settings->email }}</b>; <br>
                        Our Official Support Contact No.: <b>+91 {{ $settings->mobile }}</b></span></li>
                <li><span><i class="me-3 text-danger uil uil-check"></i></span><span>We
                ...
                <li><span><i class="me-3 text-danger uil uil-check"></i></span><span>Do
                        Not Share Your Credit Card / Debit Card /
                        Netbanking
                        Credentials /
                        Demat Account Credentials With Any Of Our Employee. If you are being asked then inform
                        us on <b>+91 {{ $settings->mobile }}</b> or E-Mail us at <b>{{ $settings->email }}</b></span></li>
                ...
                <li><span><i class="me-3 text-danger uil uil-check"></i></span><span>Investing
    ...
    <div class="rts-banner-area banner-bg-h7" style="transition: background-image 1s ease-in-out;">
        <div class="container">
            <div class="row">
...
@section('scripts')
    {{-- <script>
        $(document).ready(function() {
            ...
            var imageUrls = @json($imageUrls);

            $('#change-image').click(function() {
                // Get a random image URL
                var randomImageUrl = imageUrls[Math.floor(Math.random() * imageUrls.length)];

                // Update the background image using jQuery
                $('.banner-bg-h7').css('background-image', 'url(' + randomImageUrl + ')');
            });
        });
    </script> --}}
    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            function changeImage() {
                ...
                var currentImageUrl = imageUrls[currentIndex];

                // Update the background image using jQuery
                $('.banner-bg-h7').css('background-image', 'url(' + currentImageUrl + ')');

                // Update the index to the next image
                currentIndex = (currentIndex + 1) % imageUrls.length;
            }

            // Call changeImage function every 5 seconds (5000 milliseconds)
            setInterval(changeImage, 5000);

            // Optionally, you could also call changeImage once immediately to set the initial image
            changeImage();
        });
    </script> --}}

    <script>
        // This code fixes image flickering problem
        $(document).ready(function() {
            var imageUrls = @json($imageUrls);
            var currentIndex = 0;
    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            // Dynamically inject slides with background images
            imageUrls.forEach(function(url) {
                swiper.appendSlide(
            ...
            // Optional: Add functionality to change images (if needed)
            $('#change-image').click(function() {
                // Get a random image URL from the array
                var randomImageUrl = imageUrls[Math.floor(Math.random() * imageUrls.length)];

                // Update the first slide’s background image using jQuery
                $('.swiper-slide').first().css('background-image', 'url(' + randomImageUrl + ')');
            });
        });
    </script> --}}
