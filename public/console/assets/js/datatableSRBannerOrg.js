(function () {
    ...
    fetch(apiUrl)
        ...
        .then((protectedData) => {
            ...
            // console.log(tabledata1[0].image);
        })
        .catch((error) => {
    ...
    // axios.get("/api/getBanner/1").then((response) => {
    //     users = response.data;
    //     console.log(users);
    // });
                    ...
                    formatter: function (cell) {
                        ...
                        editBt.addEventListener("click", function () {
                            ...
                            if (editBanner.classList.contains("hide")) {
                                ...
                                editBt.innerHTML = editBt.innerHTML.replace(
                                    '<i class="ti ti-edit"></i>',
                                    '<i class="ri-reply-line"></i>'
                                );
                                editBt.style.backgroundColor = "dodgerblue";
                            } else {
                                editBanner.classList.add("hide");
                                addBanner.classList.remove("hide");
                                editBt.innerHTML = editBt.innerHTML.replace(
