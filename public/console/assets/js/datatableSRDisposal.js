(function () {
    ...
    // const apiUrl = CONSOLE_URL + "getDisposal";
    const apiUrl = "/getDisposal";
                    ...
                    formatter: function (cell) {
                        ...
                        editBt.addEventListener("click", function () {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    $("#disposalMonth").val(response.month);
                                    $("#disposalComplaints").val(
                                        response.complaints
                                    );
                        ...
                        modalBtn.addEventListener("click", function () {
                            ...
                            delBtn.addEventListener("click", function () {
                                axios
                                    .post("/disposal-destroy/" + id, {
                                        _method: "delete",
                                    })
                                    .then((res) => {
                                        window.location = "/disposal";
                                        res.json();
                                    })
                                    .then((response) => {
